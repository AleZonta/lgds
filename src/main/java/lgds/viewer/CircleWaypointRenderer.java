...
//        Double diameter = w.getDiameter();
        Double radius = 10d;
        Double diameter = 20d;
        Integer R = 255 - w.getDiameter().intValue();
        Integer G = w.getDiameter().intValue();
        g.setColor(new Color(R, G , 0, 0));
        ...
        g.setColor(new Color(R, G , 0, 127));
        g.fill(shape);
        g.setColor(new Color(R, G, 0, 90));
        g.draw(shape);
